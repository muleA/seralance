<?php
    ...
    class ServiceProvider extends User{
        ...
        public function retrieveStatistics(){
            ...
            $statistics = [];
            if($conn !== null){
                $sql = "SELECT count(*) as total_service_providers FROM user INNER JOIN service_provider ON user.username = service_provider.username";
        ...
        public function createAccount($data, $files){
            ...
            if($response['valid']==true){
                ...
                try{
                    ...
                    $mail->Username = "seralance91@gmail.com"; // SMTP username
                    $mail->Password = "hello@there123HT"; // SMTP pasword
                    $mail->SMTPSecure = "tls"; // Enable TLS encryption
                    $mail->Port = 587; // TCP port to connect to

                    // recipient
                    $mail->setFrom("seralance91@gmail.com","Seralance");
